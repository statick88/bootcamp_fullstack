...
Esto construirá la imagen Docker y ejecutará el contenedor en segundo plano. Podemos acceder a la aplicación en [http://localhost:3000](http://localhost:3000).
